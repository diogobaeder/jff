...
return foundItems;};Array.prototype.pull=function(index){return this.splice(index,1);};Array.prototype.remove=function(obj){var index=this.indexOf(obj);if(index>=0)this.pull(index);};Array.prototype.removeAll=function(obj){this.filter(function(element,index,array){return(element!=obj);});return this;};String.prototype.ucfirst=function(){var first=this.substring(0,1).toUpperCase();var rest=this.substring(1,this.length);return first+rest;};String.prototype.uToCamel=function(){return this.split('_').map(function(word){return word.ucfirst();}).join('');};window.jFF=function(message,focusAndBlur){return new jFF.core.FieldManager(message,focusAndBlur);};window.jFFField=function(jObj,message,focusAndBlur){return new jFF.core.Field(jObj,message,focusAndBlur);};window.jFFCompositeField=function(message,minValid,focusAndBlur){return new jFF.core.CompositeField(message,minValid,focusAndBlur);};window.jFFBehaviour=function(){var args=(arguments.length>1)?objectToArray(arguments).slice(1,arguments.length):[];return jFF.core.Factories.behaviour(arguments[0],args);};jFF.core=new Object();jFF.core.FieldManager=function(message,focusAndBlur){var objRef=this;this.fields=new Array();this.handlers=new Array();this.message=message;this.valid=true;this.forEach=function(callback){objRef.fields.forEach(callback);return objRef;};this.handler=function(){if(arguments.length==1&&typeof arguments[0]!='string'){objRef.handlers.push(arguments[0]);}
