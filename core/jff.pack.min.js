...
return foundItems;};Array.prototype.pull=function(index){return this.splice(index,1);};Array.prototype.remove=function(obj){var index=this.indexOf(obj);if(index>=0)this.pull(index);};Array.prototype.removeAll=function(obj){this.filter(function(element,index,array){return(element!=obj);});return this;};String.prototype.ucfirst=function(){var first=this.substring(0,1).toUpperCase();var rest=this.substring(1,this.length);return first+rest;};String.prototype.uToCamel=function(){return this.split('_').map(function(word){return word.ucfirst();}).join('');};window.jFF=function(){return new jFF.core.FieldManager();};window.jFFField=function(jObj,fieldConstraintsMessage,focusAndBlur){return new jFF.core.Field(jObj,fieldConstraintsMessage,focusAndBlur);};window.jFFCompositeField=function(fieldConstraintsMessage,minValid,focusAndBlur){return new jFF.core.CompositeField(fieldConstraintsMessage,minValid,focusAndBlur);};window.jFFBehaviour=function(){var args=(arguments.length>1)?objectToArray(arguments).slice(1,arguments.length):[];return jFF.core.Factories.behaviour(arguments[0],args);};jFF.core=new Object();jFF.core.FieldManager=function(){var objRef=this;this.fields=new Array();this.handlers=new Array();if(arguments.length>0){objectToArray(arguments).forEach(function(element,index,array){objRef.fields.push(element);});}
