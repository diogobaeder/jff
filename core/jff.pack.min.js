...
return false;};};jFF.validators.HasText=function(options){this.validate=function(field){return Boolean(field.jObj.val&&field.jObj.val());};};jFF.validators.NumChars=function(options){var objRef=this;this.min=options[0];this.max=options[1];this.validate=function(field){var chars=field.jObj.val&&field.jObj.val();if(!chars){return false;}
